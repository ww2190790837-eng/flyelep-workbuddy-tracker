...
- **镜头密度必须足够细但避免冗余**：时尚/产品/情绪/广告类成片，单个镜头时长 0.8—2.5 秒；镜头数——15秒 8—12 个、20秒 10—15 个、30秒 12—18 个、60秒 20—30 个（下限保密度，上限防冗余）。禁止压成 3—5 秒粗糙大段，也禁止为凑数堆砌重复镜头。
- 动作用可拍摄的具体动词（抬手/转身/倾倒/搅拌/撕开包装），禁止用"精彩地/酷炫地/激烈地"等空洞形容词代替实际动作。
- **格式注意：要素间用逗号分隔，保持一行一个镜头，清晰可读。**
- **禁止重复镜头**：相邻镜头不做相同动作与相同构图（如不要两次"喷香水"、两次"闭眼享受"）；如需呼应前文，必须换景别/角度/距离形成变奏而非原样复制。每个镜头应有独立信息增量（新动作/新角度/新光影）。
- **镜头类型必须交替**：时尚/产品/广告类成片，时间线不能全是人物镜头。必须穿插三类镜头并保持节奏交替：
  ① **人物镜头**（人物动作/表情/姿态，占约50—60%）
  ② **产品/道具特写**（瓶身/标签/按压/材质细节/手与产品互动，占约20—30%，至少2—3个独立产品镜）
  ③ **环境空镜/转场**（场景全景/剪影/光影氛围/水面反光/植物细节，占约10—20%，至少1—2个）
  禁止连续4个以上同类型镜头连排。产品广告必须有独立的产品特写段（不是只在人物手里带过）。
